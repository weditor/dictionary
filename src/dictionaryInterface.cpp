...
DartsDictionary::DartsDictionary()
{
}
...
vector<ResultType> DartsDictionary::search(const char *key, size_t length) const
{
    const size_t max_num_results = 64;
    InnerResultType tmpResults[max_num_results];
...
vector<ResultType> DartsDictionary::searchUtf8(const char *key, size_t length) const
{
    const size_t max_num_results = 64;
    InnerResultType tmpResults[max_num_results];
...
map<string, size_t> DartsDictionary::readFromFile(string fileName)
{
